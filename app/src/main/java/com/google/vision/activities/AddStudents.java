...
import com.google.vision.Adapters.AddStudentsAdapter;
...
public class AddStudents extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().hasExtra("class_id")
            ...
            AddStudentsAdapter mAdapter = new AddStudentsAdapter(this, usersList, selectedUid, StudentName, username);
