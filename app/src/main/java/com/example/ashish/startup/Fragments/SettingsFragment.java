...
import com.example.ashish.startup.Activities.EditProfile;
import com.example.ashish.startup.R;
import com.example.ashish.startup.Authentication.ReAuthentication;
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.change_btn:
                startActivity(new Intent(getActivity(),ReAuthentication.class));
