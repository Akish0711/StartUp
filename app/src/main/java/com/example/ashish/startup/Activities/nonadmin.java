...
public class nonadmin extends AppCompatActivity {
    ...
    private void loadHomeFragment() {
        ...
        // So using runnable, the fragment is loaded with cross_pic fade effect
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    ...
                    case R.id.nav_about_us:
                        ...
                        startActivity(new Intent(nonadmin.this, AboutUsActivity.class));
                        drawer.closeDrawers();
                        return true;
                    case R.id.nav_privacy_policy:
                        // launch new intent instead of loading fragment
                        startActivity(new Intent(nonadmin.this, PrivacyPolicyActivity.class));
                        drawer.closeDrawers();
                        return true;
                    default:
                        navItemIndex = 0;
